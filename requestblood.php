...
<div class="container-fluid" style="padding: 0px;background-color: #f5f5f5">

  

	 <form class="well form-horizontal" action="request.php" method="post"  id="contact_form" style="margin-bottom: 0px;padding: 60px">
<fieldset>
<div class="alert alert-success text-center">
  <strong>Your request will be posted to users.</strong>
</div>
<!-- Form Name -->
...
<div class="form-group">
  ...
  <input  name="p_name" placeholder="First Name" class="form-control"  type="text">
    </div>
  </div>
</div>
            ...
            hospital: {
                validators: {
                    ...
                    regexp: {
                        ...
                        notEmpty: {
                        message: 'Please supply hospital name'
                    }
                }
            },
            username: {
